...
namespace ManicureAndPedicureSalon.Controllers
{
    public class EmployersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployerId,Name,LastName,Activity")] Employer employer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployerId,Name,LastName,Activity")] Employer employer)
        {
